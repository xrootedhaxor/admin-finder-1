...
try:
    print ("\t################################################################")
    print ("\t#                                        www.cyberprotectorbd.com  #")
    print ("\t#            #####    [#]    ########   [#] #####  AdminFinder #"
)
    print ("\t#                                                              #"
)
    print ("\t#Coded by XR00T3D-H4X0R#"
)
    print ("\t# Gretzz: All members of TeaM_CPBD #"
)
    print ("\t################################################################"
)
    var1=0
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf']
    ...
    if code==1:
        ...
        for admin in php:
            ...
            host = site + admin
            print ("\t [#] Checking " + host + "...")
            connection = httplib2.HTTPConnection(site)
    ...
    if code==6:
        ...
        raw_input("The Game Over; Press Enter to Exit")
except (httplib2.Response, socket.error):
